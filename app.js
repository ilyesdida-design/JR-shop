...
categoriesBox.innerHTML = `     <p>Chargement des catégories...</p>
  `;
...
categoriesBox.innerHTML = ` <button
   class="cat active"
   data-cat=""
 > <span>Toutes</span> </button>
...
productsBox.innerHTML = `     <p>Chargement des produits...</p>
  `;
